...
const japanSeeds: readonly Seed[] = [
  { id: "jp-gion", title: "Gion", location: "Gion", city: "Kyoto", category: "neighborhood", unlockMethods: ["photo", "manual"] },
  { id: "jp-fushimi-inari", title: "Fushimi Inari Taisha", location: "Fushimi Inari", city: "Kyoto", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-tokyo", title: "Tokio", location: "Tokio", city: "Tokyo", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-nara-park", title: "Parque de Nara", location: "Nara Park", city: "Nara", category: "nature", unlockMethods: ["photo", "manual"] },
  { id: "jp-kinkaku-ji", title: "Kinkaku-ji", location: "Kinkaku-ji", city: "Kyoto", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-meiji-jingu", title: "Meiji Jingu", location: "Meiji Jingu", city: "Tokyo", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-himeji-castle", title: "Castillo de Himeji", location: "Himeji Castle", city: "Himeji", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-hakone-lake-ashi", title: "Lago Ashi", location: "Hakone · Lago Ashi", city: "Hakone", category: "nature", unlockMethods: ["photo", "manual"] },
  { id: "jp-miyajima", title: "Miyajima", location: "Itsukushima · Miyajima", city: "Hatsukaichi", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-akihabara", title: "Akihabara", location: "Akihabara", city: "Tokyo", category: "neighborhood", unlockMethods: ["photo", "manual"] },
  { id: "jp-kiyomizu-dera", title: "Kiyomizu-dera", location: "Kiyomizu-dera", city: "Kyoto", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-tokyo-skytree", title: "Tokyo Skytree", location: "Tokyo Skytree", city: "Tokyo", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-ueno-park", title: "Parque Ueno", location: "Ueno Park", city: "Tokyo", category: "nature", unlockMethods: ["photo", "manual"] },
  { id: "jp-odaiba", title: "Odaiba", location: "Odaiba", city: "Tokyo", category: "neighborhood", unlockMethods: ["photo", "manual"] },
  { id: "jp-great-buddha-kamakura", title: "Gran Buda de Kamakura", location: "Kamakura Daibutsu", city: "Kamakura", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-hiroshima-memorial", title: "Memorial de la Paz de Hiroshima", location: "Hiroshima Peace Memorial", city: "Hiroshima", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-kobe-harbor", title: "Puerto de Kobe", location: "Kobe Harbor", city: "Kobe", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-yokohama-minato-mirai", title: "Minato Mirai", location: "Yokohama · Minato Mirai", city: "Yokohama", category: "landmark", unlockMethods: ["photo", "manual"] },
  { id: "jp-shirakawa-go", title: "Shirakawa-go", location: "Shirakawa-go", city: "Shirakawa", category: "culture", unlockMethods: ["photo", "manual"] },
  { id: "jp-nikko-toshogu", title: "Nikkō Tōshō-gū", location: "Nikkō Tōshō-gū", city: "Nikko", category: "landmark", unlockMethods: ["photo", "manual"] },
];
